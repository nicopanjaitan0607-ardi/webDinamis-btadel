...
if($_GET['resid'])
{
	...
	$msg="Kategori Berhasil Dikembalikan";
}
...
<html lang="en">
    <head>
        ...
        <title> Berita | Kelola Sub-Kategori</title>
...
<td colspan="7" align="center"><h3 style="color:red">Hasil Tidak Ditemukan</h3></td>
<tr>
<?php 
} else {
...
<div class="m-b-30">
 ...
 <h4><i class="fa fa-trash-o" ></i>Kategori Di Hapus</h4>
