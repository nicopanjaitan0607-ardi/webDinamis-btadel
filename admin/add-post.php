...
{
echo "<script>alert('Format Gambar Tidak Valid. Hanya jpg / jpeg/ png /gif format Yang Di Ijinkan');</script>";
}
else
{
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Detail Post</b></h4>
...
<button type="submit" name="submit" class="btn btn-success waves-effect waves-light">Simpan Dan Post</button>
 <button type="button" class="btn btn-danger waves-effect waves-light">Buang</button>
                                        </form>
                                    </div>
                                </div> <!-- end p-20 -->
                            </div> <!-- end col -->
