...
{
echo "<script>alert('Format Tidak Valid. Hanya jpg / jpeg/ png /gif format Yang Bisa');</script>";
}
else
{
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Gambar Sekarang</b></h4>
