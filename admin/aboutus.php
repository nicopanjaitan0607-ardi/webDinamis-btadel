...
if($query)
{
$msg="Laman Jajan BTA telah berhasil diuodate ";
}
else{
$error="Terjadi Error.Silahkan coba lagi";    
} 
...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>BTA | Laman Jajan BTA</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Laman Jajan BTA  </h4>
